...
func TestToOne(t *testing.T) {
	t.Run("RoleToGuildUsingGuild", testRoleToOneGuildUsingGuild)
}
...
func TestToMany(t *testing.T) {
	t.Run("GuildToRoles", testGuildToManyRoles)
}

// TestToOneSet tests cannot be run in parallel
// or deadlocks can occur.
func TestToOneSet(t *testing.T) {
	t.Run("RoleToGuildUsingRoles", testRoleToOneSetOpGuildUsingGuild)
}
...
func TestToManyAdd(t *testing.T) {
	t.Run("GuildToRoles", testGuildToManyAddOpRoles)
}
