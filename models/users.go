...
type User struct {
	DiscordID int64 `boil:"discord_id" json:"discord_id" toml:"discord_id" yaml:"discord_id"`
...
var UserWhere = struct {
	DiscordID whereHelperint64
	SteamID   whereHelperint64
}{
	DiscordID: whereHelperint64{field: "\"users\".\"discord_id\""},
	SteamID:   whereHelperint64{field: "\"users\".\"steam_id\""},
}
...
var (
	userAllColumns            = []string{"discord_id", "steam_id"}
	userColumnsWithoutDefault = []string{"discord_id", "steam_id"}
	userColumnsWithDefault    = []string{}
	userPrimaryKeyColumns     = []string{"discord_id"}
)
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, discordID int64, selectCols ...string) (*User, error) {
	userObj := &User{}
	...
	query := fmt.Sprintf(
		"select %s from \"users\" where \"discord_id\"=$1", sel,
	)
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, discordID int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"users\" where \"discord_id\"=$1 limit 1)"
